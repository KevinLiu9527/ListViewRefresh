package com.kevin.listviewrefresh.utils;
...
import com.kevin.listviewrefresh.R;
import com.kevin.listviewrefresh.utils.core.RefreshLayout;
import com.kevin.listviewrefresh.utils.core.WaveView;
import com.kevin.listviewrefresh.utils.listener.OnRefreshListener;
import com.kevin.listviewrefresh.utils.listener.PullToRefreshListener;
import com.kevin.listviewrefresh.utils.listener.PullWaveListener;
import com.kevin.listviewrefresh.utils.utils.DensityUtil;
import com.kevin.listviewrefresh.utils.utils.LogHelper;

/**
 * 你好，当你看到这个类的时候，说明你已经知道我了。但是，我还是要介绍下：我是CJJ,会写代码
 * 会写小说，会唱歌，会踢球，最主要的是，装得一手好逼。恩，我还喜欢搞基，加我微信androidcjj.
 */
public class KevinRefreshLayout extends RefreshLayout {
    ...
    public KevinRefreshLayout(Context context) {
        this(context, null, 0);
    }

    public KevinRefreshLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KevinRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
